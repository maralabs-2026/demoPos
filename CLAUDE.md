...
- Particularidades de kiosco a tener en cuenta desde la demo: muchas ventas de un solo ítem de bajo monto, redondeo del vuelto en efectivo a múltiplos de $10 (configurable), y productos que se venden por unidad y por pack (dejar `unidad_venta` en productos como campo de texto, sin lógica todavía).
